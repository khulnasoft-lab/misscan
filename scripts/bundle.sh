...
rsync -avr --exclude=README.md --exclude="*_test.rego" --exclude="*.go" --exclude=compliance --exclude=test --exclude=advanced pkg/rules/ bundle/policies/
cp pkg/rules/.manifest bundle/
