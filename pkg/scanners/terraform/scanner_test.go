...
import (
	...
	"github.com/aquasecurity/misscan/internal/rules"
	"github.com/aquasecurity/misscan/pkg/providers"
	"github.com/aquasecurity/misscan/pkg/scan"
	"github.com/aquasecurity/misscan/pkg/scanners/options"
	"github.com/aquasecurity/misscan/pkg/severity"
	"github.com/aquasecurity/misscan/pkg/state"
	"github.com/aquasecurity/misscan/pkg/terraform"
	"github.com/aquasecurity/misscan/test/testutil"
...
__rego_input__ := {
	"combine": false,
	"selector": [{"type": "misscan", "subtypes": [{"service": "s3", "provider": "aws"}]}],
}
...
__rego_input__ := {
	"combine": false,
	"selector": [{"type": "misscan", "subtypes": [{"service": "ecs", "provider": "aws"}]}],
}
