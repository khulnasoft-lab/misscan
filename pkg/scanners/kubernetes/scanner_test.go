...
func Test_FileScanWithPolicyReader(t *testing.T) {
	...
	results, err := NewScanner(options.ScannerWithPolicyReader(strings.NewReader(`package misscan
...
func Test_FileScanWithMetadata(t *testing.T) {
	...
	results, err := NewScanner(
		...
		options.ScannerWithPolicyReader(strings.NewReader(`package misscan
