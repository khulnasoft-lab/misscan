...
func (p *Property) AsStringValue() misscanTypes.StringValue {
	if p.unresolved {
		return misscanTypes.StringUnresolvable(p.Metadata())
	}
	return misscanTypes.StringExplicit(p.AsString(), p.Metadata())
}
...
func (p *Property) AsIntValue() misscanTypes.IntValue {
	if p.unresolved {
		return misscanTypes.IntUnresolvable(p.Metadata())
	}
	return misscanTypes.IntExplicit(p.AsInt(), p.Metadata())
}
...
func (p *Property) AsBoolValue() misscanTypes.BoolValue {
	if p.unresolved {
		return misscanTypes.BoolUnresolvable(p.Metadata())
	}
	return misscanTypes.Bool(p.AsBool(), p.Metadata())
}
