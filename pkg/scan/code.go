...
func (r *Result) getHighlightedLines(outerRange, innerRange misscanTypes.Range, rawLines []string, settings codeSettings) []string {
	...
	fsKey := misscanTypes.CreateFSKey(innerRange.GetFS())
...
func (r *Result) getOuterRange() misscanTypes.Range {
...
func (r *Result) getTruncatedLines(outerRange, innerRange misscanTypes.Range, rawLines, highlightedLines []string) []Line {
	var lines []Line
...
func (r *Result) getAllLines(outerRange, innerRange misscanTypes.Range, rawLines, highlightedLines []string) []Line {
