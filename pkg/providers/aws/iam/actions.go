...
var allowedActionsForResourceWildcardsMap = map[string]struct{}{
	...
	"bracket:AcceptUserAgreement": {},
	"bracket:AccessBraketFeature": {},  // This can also be fixed to 'bracket'
	"bracket:CreateJob": {},
	"bracket:CreateQuantumTask": {},
	"bracket:GetDevice": {},
	"bracket:GetServiceLinkedRoleStatus": {},
	"bracket:GetUserAgreementStatus": {},
	"bracket:SearchDevices": {},
	"bracket:SearchJobs": {},
	"bracket:SearchQuantumTasks": {},
