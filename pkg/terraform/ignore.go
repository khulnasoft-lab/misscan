...
func (ignores Ignores) Covering(modules Modules, m misscanTypes.Metadata, workspace string, ids ...string) *Ignore {
...
func (ignore Ignore) Covering(modules Modules, m misscanTypes.Metadata, workspace string, ids ...string) bool {
...
func (ignore Ignore) MatchParams(modules Modules, blockMetadata *misscanTypes.Metadata) bool {
