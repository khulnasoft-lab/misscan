...
func Int(i int) misscanTypes.IntValue {
	return misscanTypes.Int(i, misscanTypes.NewTestMetadata())
}

func Bool(b bool) misscanTypes.BoolValue {
	return misscanTypes.Bool(b, misscanTypes.NewTestMetadata())
}

func String(s string) misscanTypes.StringValue {
	return misscanTypes.String(s, misscanTypes.NewTestMetadata())
}
