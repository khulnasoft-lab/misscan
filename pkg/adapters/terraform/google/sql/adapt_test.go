				...
				Instances: []sql.DatabaseInstance{
					{
						...
						Settings: sql.Settings{
							...
							IPConfiguration: sql.IPConfiguration{
								...
								SSLMode:    misscanTypes.StringTest("TRUSTED_CLIENT_CERTIFICATE_REQUIRED"),
				...
				Instances: []sql.DatabaseInstance{
					{
						...
						Settings: sql.Settings{
							Flags: sql.Flags{
								ContainedDatabaseAuthentication: misscanTypes.BoolTest(true),
								CrossDBOwnershipChaining:        misscanTypes.BoolTest(true),
								LogMinDurationStatement:         misscanTypes.IntTest(-1),
								LogTempFileSize:                 misscanTypes.IntTest(-1),
							},
							IPConfiguration: sql.IPConfiguration{
								EnableIPv4: misscanTypes.BoolTest(true),
							},
						},
					},
				},
