...
func adaptPostgreSQLConfiguration(resource azure.Resource, deployment azure.Deployment) database.PostgresSQLConfig {
	...
	config := database.PostgresSQLConfig{
		Metadata:             resource.Metadata,
		LogCheckpoints:       misscanTypes.BoolDefault(false, resource.Metadata),
		ConnectionThrottling: misscanTypes.BoolDefault(false, resource.Metadata),
		LogConnections:       misscanTypes.BoolDefault(false, resource.Metadata),
	}
