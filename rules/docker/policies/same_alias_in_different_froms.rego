# METADATA
# title: "Duplicate aliases defined in different forms"
# description: "Different forms can't have the same alias defined."
# scope: package
# schemas:
...
deny[res] {
	...
	msg := sprintf("Duplicate aliases '%s' are found in different forms", [output.alias])
