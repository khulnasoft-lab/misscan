...
import (
	...
	registered "github.com/khulnasoft-lab/misscan/pkg/rules"
)
...
// nolint: cyclop
func writeDocsFile(meta registered.RegisteredRule, path string) {

	tmpl, err := template.New("misscan").Parse(docsMarkdownTemplate)
	if err != nil {
